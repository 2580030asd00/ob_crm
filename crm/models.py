...
class Customer(models.Model):
	...
	def show_status(self):
		...
		return mark_safe(
			'<span style="background-color: {};color: white;padding: 4px">{}</span>'.format(color_dict.get(self.status),
...
class CourseRecord(models.Model):
	...
	teacher = models.ForeignKey('UserProfile', verbose_name="讲师", related_name='t_course_records', on_delete=models.CASCADE)
	recorder = models.ForeignKey('UserProfile', verbose_name="记录者", related_name='r_course_records', on_delete=models.CASCADE)
